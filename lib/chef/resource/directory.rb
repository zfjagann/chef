  ...
  class Resource
    class Directory < Chef::Resource
      ...
      property :recursive, [ TrueClass, FalseClass ],
               description: "Create parent or delete children directories recursively. For the owner, group, and mode properties, the value of this property applies only to the leaf directory.",
               default: false
    end
  end
end
